...
kern_return_t ps_msg_sig_post
    ...
    (process, signal, sigcode, refport)
	mach_port_t process;
	int signal;
	natural_t sigcode;
	mach_port_t refport;
{ return ps_msg_sig_post(process, signal, sigcode, refport); }
#else
(
	mach_port_t process,
	int signal,
...
kern_return_t ps_msg_sig_post_untraced
	...
	natural_t sigcode;
	mach_port_t refport;
{ return ps_msg_sig_post_untraced(process, signal, sigcode, refport); }
#else
(
	mach_port_t process,
	int signal,
...
extern
#endif
kern_return_t ps_msg_describe_ports
#if	defined(LINTLIBRARY)
    (process, refport, names, namesCnt, descriptions, descriptionsCnt)
	mach_port_t process;
	mach_port_t refport;
...
{ return ps_msg_describe_ports(process, refport, names, namesCnt, descriptions, descriptionsCnt); }
#else
(
	mach_port_t process,
	mach_port_t refport,
